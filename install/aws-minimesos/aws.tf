...
resource "aws_vpc" "terraform" {
  ...
  tags = {
    ...
    yor_trace = "fe34e7da-e650-4ad4-aaee-05905b170cd5"
  }
}
...
resource "aws_internet_gateway" "terraform" {
  ...
  tags = {
    git_repo  = "microservices-demo"
    yor_trace = "f4965387-de7e-4aad-be5f-ed836de77b1f"
  }
}
...
resource "aws_subnet" "terraform" {
  ...
  tags = {
    git_repo  = "microservices-demo"
    yor_trace = "83c7740d-ca17-4e9e-87e7-7e23bfd1d724"
  }
}
...
resource "aws_route_table" "terraform" {
  ...
  tags = {
    git_repo  = "microservices-demo"
    yor_trace = "dadde07d-93c1-45c3-9e22-acf8797e0421"
  }
}
...
resource "aws_security_group" "terraform" {
  ...
  tags = {
    git_repo  = "microservices-demo"
    yor_trace = "ac990f0c-62fb-45b0-8c26-47a47aaac1a7"
  }
}
