...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    ...
    yor_trace = "59640185-5f01-49aa-bff7-0ecbe0d570d3"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    git_repo  = "microservices-demo"
    yor_trace = "f89488bd-250d-41ff-8332-1ce85b5c5434"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    git_repo  = "microservices-demo"
    yor_trace = "ba253ea8-6898-405e-af2e-9b6f7c318daf"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    git_repo  = "microservices-demo"
    yor_trace = "b7e6b314-ee18-4206-b341-2604ada80868"
  }
}
